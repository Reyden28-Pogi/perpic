...
const SOCIAL_COLORS = {
  ...
  Instagram: '#E4405F', Twitter: '#000000', LinkedIn: '#0A66C2'
}
...
export default function Contact() {
  ...
  const socials = Object.entries(SocialIcons)
    .map(([key, Icon]) => ({ key, Icon, href: settings[key.toLowerCase()], color: SOCIAL_COLORS[key] }))
    .filter(s => s.href)
          ...
          <div className="contact-info">
            ...
            <div className="contact-detail">
              ...
              <div>
                ...
                <a href={`mailto:${settings.email}`} className="contact-detail__value">{settings.email}</a>
              </div>
            </div>
            <div className="contact-detail">
              ...
              <div>
                ...
                <span className="contact-detail__value">{settings.phone}</span>
              </div>
            </div>
            <div className="contact-detail">
              ...
              <div>
                ...
                <span className="contact-detail__value">{settings.address}</span>
              </div>
            </div>
            ...
            {settings.calendly_url && (
              <div className="contact-cta-block">
                ...
                <a href={settings.calendly_url} target="_blank" rel="noopener noreferrer"
                  className="btn-primary contact-cta-btn">Book via Calendly</a>
              </div>
            )}
            ...
            {settings.zoom_link && (
              <div className="contact-cta-block">
                ...
                <a href={settings.zoom_link} target="_blank" rel="noopener noreferrer"
                  className="btn-outline contact-cta-btn">Open Zoom</a>
              </div>
            )}
            ...
            {socials.length > 0 && (
              <div className="contact-socials">
                ...
                <div className="contact-socials__grid">
                  {socials.map(({ key, Icon, href, color }) => (
                    <a key={key} href={href} target="_blank" rel="noopener noreferrer"
                      className="contact-social-link" aria-label={key}>
                      <div className="contact-social-link__icon" style={{ '--social-color': color }}>
                        <Icon />
                      </div>
                      <span className="contact-social-link__label">{key}</span>
                    </a>
                  ))}
                </div>
              </div>
          ...
          <div className="container">
            <div className="calendly-section">
              ...
              <div className="calendly-embed-wrap">
                <iframe
                  src={`${settings.calendly_url}?embed_type=Inline&hide_event_type_details=1&hide_gdpr_banner=1`}
                  width="100%" height="700" frameBorder="0"
                  title="Book a meeting" className="calendly-iframe"
                />
              </div>
            </div>
          </div>
